...
public enum Rarity {
    ...
    VERY_RARE("Molto Raro", new Color(0.05490196078431372549019607843137, 0.16862745098039215686274509803922, 0.92156862745098039215686274509804, 1)),
    LEGENDARY("Leggendario", new Color(0.4078431372549019607843137254902, 0.06666666666666666666666666666667, 0.67058823529411764705882352941176, 1)),
